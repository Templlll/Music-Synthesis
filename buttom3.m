function buttom3(ax)
    ...
    generateNote = @(f,duration) (sin(2*pi*f*(0:1/fs:duration))+sin(4*pi*f*(0:1/fs:duration))*1.46+sin(6*pi*f*(0:1/fs:duration))*0.96+sin(8*pi*f*(0:1/fs:duration))*1.1).*exp(-5*(0:1/fs:duration)/duration);
